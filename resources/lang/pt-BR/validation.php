...
return [
    ...
    */
    ...
    'cpf'                  => 'O campo CPF deve ser válido',
    ...
    'config' => [
        'not_allowed' => 'Alteração da propriedade :attribute não permitida.'
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        ...
        'airport_cod'   => 'código do aeroporto',
        'airport_name'  => 'nome do aeroporto',
        'shipping_fee'  => 'taxa de embarque', 
        'departure_date' => 'data de partida',
        'value'         => 'valor da passagem',
        'special_seats' => 'assentos especiais',
        'seats'         => 'assentos comuns,',
        'airplane_id' => 'código do avião',
        'destiny_id' => 'destino',
    ],
