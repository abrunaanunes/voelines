<template>
    <jet-action-section>
        <template #title>
            Sessões em navegadores
        </template>

        <template #description>
            Gerencie ou faça logout nos dispositivos conectados à sua conta.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Se necessário, você poderá sair de todos os outros navegadores ou dispositivos conectados à sua conta. Algumas das suas atividades de acesso recentes. Se você desconfiar que sua conta pode ter sido comprometida, você poderá alterar sua senha de acesso.
            </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, insira sua senha para confirmar que você deseha desconectar todas as suas outras sessões em navegadores e/ou dispositivos.
