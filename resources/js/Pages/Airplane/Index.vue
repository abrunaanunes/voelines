    ...
    <AppLayout title="Aviões">
        <template #header>
            <div class="flex flex-row justify-between">
                ...
                <div>
                    <a :href="route('admin.avioes.create')" class="bg-teal-900 hover:bg-teal-600  text-white font-bold py-2 px-4 rounded">Novo avião</a>
                </div>
            </div>
        </template>
