...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-teal-600 border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('admin.avioes.index')" :active="route().current('dashboard')">
                                    Aviões
                                </JetNavLink>

                                <JetNavLink :href="route('admin.destinos.index')" :active="route().current('dashboard')">
                                    Destinos
                                </JetNavLink>

                                <JetNavLink :href="route('admin.voos.index')" :active="route().current('dashboard')">
                                    Voos
                                </JetNavLink>

                                <JetNavLink :href="route('admin.passagens.index')" :active="route().current('dashboard')">
                                    Passagens 
                                </JetNavLink>
                            </div>
                        </div>
